  ...
  return (
    <section className="regist">
      ...
      <form className="regist__form" >
        ...
        <input className="regist__form_input" placeholder="Введите ваше имя" required></input>
        <label className="regist__form_type">E-mail</label>
        <input className="regist__form_input" placeholder="Введите ваш E-mail" required></input>
        <label className="regist__form_type">Пароль</label>
        <input className="regist__form_input" placeholder="Придумайте пароль" required></input>
